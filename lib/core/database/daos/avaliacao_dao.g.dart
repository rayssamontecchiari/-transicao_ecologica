...
mixin _$AvaliacaoDaoMixin on DatabaseAccessor<AppDatabase> {
  ...
  $DimensaoTable get dimensao => attachedDatabase.dimensao;
  $IndicadorTable get indicador => attachedDatabase.indicador;
  $PraticaTable get pratica => attachedDatabase.pratica;
  $AvaliacaoItemTable get avaliacaoItem => attachedDatabase.avaliacaoItem;
}
